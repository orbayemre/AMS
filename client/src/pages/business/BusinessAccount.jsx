...
export default function BusinessAccount(){
    ...
    const [selected, setSeleceted] = useState('appointments');
        ...
        <div className="container accountContainer font-josefin-500">
            <Sidebar className="sidebar"  collapsed={collapsed} transitionDuration={500}>
                <div className="hamburger">
                    <Hamburger toggled={!collapsed} toggle={() => setCollapsed(!collapsed)} />
                </div>
                <Menu className="menu">
                    <MenuItem active={selected=="appointments"} className="menuItem" id="appointments" onClick={()=>setSeleceted('appointments')}> 
                    ...
                    <MenuItem active={selected=="info"} className="menuItem" id="info" onClick={()=>setSeleceted('info')}> 
                    ...
                    <MenuItem active={selected=="settings"} className="menuItem" id="settings" onClick={()=>setSeleceted('settings')}>
