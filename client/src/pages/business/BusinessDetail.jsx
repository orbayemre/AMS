...
export default function BusinessDetail(){
    ...
    return(
        <>
            <NavBar/>
            <div className="container detailContainer font-josefin-500">
                <div className="header">
                    <div className="names">
                        <h1 className="name">{business.name}</h1>
                        <span className="longName">{business.long_name}</span>
                    </div>
                    <div className="type">
                        <TypeIcon type={business.type}/>
...

                {
                    (business.content && business.content !== "" ) && 
                        <div className="businessContent">
                            <h2 className="infoHeader">{t('Description')}</h2>
                            <p className="desc">
                                {business.content}
                            </p>
                        </div>
...

                {
                    (business.services && business.services.length > 0 ) && 
                        <div className="businessServices">
                            <h2 className="infoHeader">{t('Services')}</h2>
                ...
                {
                    <div className="businessAddressContact">
                        <h2 className="infoHeader">{t('Address and Contact Info')}</h2>
                        <div className="addressContact">
                            {
                                
                                (business.address.district && business.address.city && business.address.address_text) && 
                                <div className="address">
                                    {
                                        (business.address.district && business.address.city) && 
                                        <span className="cityDistrict">
                                            {business.address.district}, {business.address.city}
                                        </span>
                                    }
                                    {
...

                {
                    (business.images && business.images.length > 0 ) && 
                        <div className="businessGallery">
                            <h2 className="infoHeader">{t('Images of the business')}</h2>
                ...
                { 
                    !hasSub ?  
                        <div >
                            <h2 className="infoHeader calendarHeader">{t('Appointment Calendar of the Business')} </h2>
                            <Calendar
                                id = {bId}  
                                isSub = {false}
                    ...
                    :
                        subs.map((sub) =>{
                            return( 
                                <div key={sub._id}>
                                    <h2 className="infoHeader calendarHeader">
                                        {t("{keyword}'s Appointment Calendar" ).split("{keyword}")[0]}
                                        {sub.name}
                                        {t("{keyword}'s Appointment Calendar" ).split("{keyword}")[1]}
                                    </h2>
                                    <Calendar
                                        id = {sub._id}  
                                        isSub = {true}
...
const TypeIcon = ({type}) =>{
    ...
    if(type == "hairdresser"){
        ...
        return(
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 460.425 460.425" xmlSpace="preserve">
                <g>
                    <g>
                        <g>
        ...
        return(
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 403.647 403.647" xmlSpace="preserve">
                <g>
                    <g>
        ...
        return(
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32.074 32.074" xmlSpace="preserve">
                <g>
                    <g>
    ...
    else if(type == "auto-service"){
        return(
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" id="car-repair">
        ...
        return(
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 190" xmlSpace="preserve">
