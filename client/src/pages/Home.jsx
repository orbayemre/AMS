...
export default function Home(){
    ...
    const goWithType = (type) =>{
      navigate("/search?type=" + encodeURI(type))
    }
          ...
          <div className='container homeContainer'>
              ...
              <div className='animations'>
                <div className='mainAnimation'>
                  <Lottie link={"https://lottie.host/7f0c91a3-c248-4509-8038-c877b5d56efe/R4v2cDfB0V.json"} width={"600px"} height={"300px"}/>
                </div>

              </div>

              <div className='homeHeaderText font-josefin-600'>
                {t('home desc')}
              </div>
              <div className='searchBox'>
                <SearchInput value={q ? q : ""} placeholder={t('Search for business')} onChange={handleQ} submit={goWithQ}/>
              </div>
              <div className='typeBox'>
                
              <div className="radio-tile-group">
                  <div className="input-container" onClick={() => goWithType("hairdresser")}>
                  ...
                  <div className="input-container" onClick={() => goWithType("beauty-salon")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("psychologist")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("dental-clinic")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("astroturf")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("auto-service")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("massage-center")}>
                      <div className="radio-tile">
                  ...
                  <div className="input-container" onClick={() => goWithType("consultancy-service")}>
                      <div className="radio-tile">
