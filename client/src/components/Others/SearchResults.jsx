...
export default function SearchResults({results}){
    ...
    const goToDetail = (e,id)=>{
        ...
        if(isLogin || userType == "user"){
            ...
            toast.error(t("You must be logged in to view business detail pages."), {
        ...
        <div className="results">
            {
                results.map((business,index) =>{
                    return(
                        <a key={index} className="result business" onClick={(e) => goToDetail(e,business._id)} href={"/business/detail/"+business._id}>
                            <div className="head">
                                <h2>
                            ...
                            <div className="body">
                                    {
                                        ...
                                        <div className="address">
                                            <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 0 24 24">
                                                <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            ...
                                            <span>
                                                {t(business.address.district)} , {t(business.address.city)}
                                            </span>
                                        </div>
                                    }
                                    {
                                        ...
                                        <div className="services">
                                            ...
                                            <ul>
                                                {business.services.slice(0, 5).map((service,index) =>
                                                    <li key={index}>{service}{index!==4 ? "," :""}</li> 
                                                )}
                                            </ul>
                                        </div>
                                    }

                                    {
                                        <div className="workDays">
                                            <h4>{t('Working days')}:</h4>
                                            <ul>
                                                {['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'].map((day,index) =>{
                                                    if(business.working_days.days[index]){
                                                        return(
                                                            <li key={index}>{index!==0 ? ", " :""}{t(day)}</li> 
                                                        )
                                                    }
